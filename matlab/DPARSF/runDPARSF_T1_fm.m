// Run DPARSF with T1 normalization and fieldmap correction
clear all
close all
...
%% ADD PATHS
addpath(genpath([dataPartitionPath 'delfi/neurotools/dpabi/DPABI_V9.0_250415'])) %CHECK VERSION 
addpath([dataPartitionPath 'delfi/neurotools/spm12/spm_25.01.02/spm/'])
addpath([dataPartitionPath 'delfi/neurotools/dpabi/DPABI_V9.0_250415/DPARSF/']) %CHECK VERSION
%% DEFAULT CONFIG FILE
...
filenameMriInfo = [dataPath 'mriInfoAndProcessing_2025_06_06.mat'];
%% DATA INFO
...
%% Fieldmaap correction
cfg.FieldMap.IsCalculateVDM = 1; 
cfg.FieldMap.IsNeedConvertDCM2IMG = 0;
cfg.FieldMap.IsFieldMapCorrectionUnwarpRealign = 1;

cfg.FieldMap.DataFormat = 'PhaseDiff';
% cfg.FieldMap.TE1 = 0.00492;  
% cfg.FieldMap.TE2 = 0.00738; 
cfg.FieldMap.TE1 = 0;  %Selection from the json
cfg.FieldMap.TE2 = 0; %Selection from the json
...
cfg.CalFC.ROIDef = {[dataPartitionPath 'delfi/neurotools/dpabi/DPABI_V9.0_250415/Templates/aal.nii']};
%% CHECK DATA
j = 0;
% Get all subjects:

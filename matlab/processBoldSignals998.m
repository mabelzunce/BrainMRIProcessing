...
%% PROCESS ROI SIGNALS
boldPath = '/home/martin/data/UNSAM/CEMSC3/ProcesamientoADNI/atlas 998 ROI-20230308T171237Z-001/atlas 998 ROI';
%% AD
adPath = [boldPath '/ROI Signals AD (individuales)/'];
...
%% CN
cnPath = [boldPath '/ROI Signals CN (individuales)/'];
...
%% LEFT AND RIGHT
ATLAS = atlasRois;
labelNames = strip(string(atlasRois.anat_lbls));
indicesRoisR = find(startsWith(labelNames, 'r')>0);
indicesRoisL = find(startsWith(labelNames, 'l')>0);

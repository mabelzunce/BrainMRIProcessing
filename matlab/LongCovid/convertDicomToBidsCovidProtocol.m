...
preprocessedDataPath = [dataImagingPartitionPath '/CovidProject/Estudio/BidsDataBase/'];
% Second study:
dicomDataPath = [dataPartitionPath '/UNSAM/CovidProject2/Imaging/MRI/'];
preprocessedDataPath = [dataImagingPartitionPath '/UNSAM/CovidProject/Estudio2/BidsDataBase/'];

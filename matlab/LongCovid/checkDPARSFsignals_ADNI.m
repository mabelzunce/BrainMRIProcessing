...
dparsfDataPath = dataPath; %[imagingPartitionPath '/CovidProject/Estudio/PreprocessedMRI/DPARSF/'];
%dparsfDataPath = [imagingPartitionPath '/CovidProject/Estudio2/PreprocessedMRI/DPARSF/'];
outputCheckPath = [dparsfDataPath '/check/'];
preprocessedImageSubdir = '/NiftiPreprocessedAllBatchesNorm/';
...
%% CHECK DATA
listDir = dir(preprocessedImageSubdir);
